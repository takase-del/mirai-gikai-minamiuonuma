  ...
  return (
    <div
      className="
            ...
            [&_table]:my-4 [&_table]:text-sm [&_table]:border-collapse
            [&_thead]:bg-mirai-surface-grouped
            [&_th]:border [&_th]:border-mirai-border [&_th]:px-3 [&_th]:py-2
            [&_th]:text-left [&_th]:font-bold [&_th]:whitespace-nowrap
