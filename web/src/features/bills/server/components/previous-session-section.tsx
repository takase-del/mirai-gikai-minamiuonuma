...
export function PreviousSessionSection({
  ...
  return (
    <section className="flex flex-col gap-6">
      ...
      {/*
        「もっと読む」は直前の会期に閉じているので、それより前の会期へ行く
        導線がここに無いと、トップから過去の議案に到達できない。
      */}
      <div className="flex justify-center">
        <Link
          href={routes.gikaiSessions() as Route}
          className="inline-flex items-center gap-1 text-[15px] font-bold text-mirai-brand-teal-hover hover:underline"
        >
          ほかの会期から探す
