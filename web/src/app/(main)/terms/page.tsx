...
import { SITE_NAME, SITE_OPERATOR } from "@/config/site";
  ...
  return (
    ...
    >
      <Container className="space-y-10">
        ...
        <LegalParagraph>
          {SITE_NAME}
          （以下「本サービス」といいます。）をご利用いただく場合、以下の規約に同意いただいたものとみなします。本サービスは
          {SITE_OPERATOR}
          （以下「当方」といいます。）が運営しています。
        </LegalParagraph>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <LegalList
              items={[
                "個人情報の掲載：氏名、住所、電話番号、メールアドレス、SNS ID、口座番号、所属組織等、本人・他人を問わず特定の個人を識別できる情報の入力（当方が別途入力を依頼した場合を除きます。）。",
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            当方は、ユーザーが前条の禁止事項に該当すると判断した場合、事前に通知することなく以下の措置を講じることができるものとします。
          </LegalParagraph>
          <LegalList
            items={[
              ...
              },
              {
                ...
                content: (
                  <>
                    ...
                    本人が公開に同意しなかったインタビューデータについても、当方において、サービス向上、政策立案、不正対策その他当方サービスの運営上必要な目的で利用するものとし、ユーザーはこれに同意するものとします。この場合でも、当該データが第三者に公開または提供されることはありません。ただし、法令に基づく場合、および個人を特定できない統計情報に加工して利用・公表する場合を除きます。
                  </>
                ),
              },
              {
                ...
                content: (
                  <>
                    ...
                    本サービスを通じて生成された応答や対話ログに関する権利（著作権法第27条および第28条の権利を含みます。）は、当方に帰属すること、またはユーザーが当方に対して無償で利用（複製、加工、公表、および本人が公開に同意した範囲におけるオープンデータとしての第三者への利用許諾を含みます。）することを許諾したものとみなします。また、ユーザーは、当方および当方から利用を許諾された第三者に対し、著作者人格権を行使しないものとします。なお、公表については、本条第1項のとおりユーザー本人が公表に同意した場合のみ実施するものとします。
                  </>
                ),
              },
            ]}
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            本サービスの提供に用いられるプログラム、コンテンツ、テキスト、画像等に関する一切の権利は、当方または正当な権利者に帰属します。ユーザーは私的利用の範囲を超えてこれらを使用してはなりません。
          </LegalParagraph>
        </section>
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            当方は、本サービス（AIによる回答を含む）が提供する情報の正確性、完全性、最新性、有用性、真実性等について、いかなる保証も行いません。
          </LegalParagraph>
          <LegalParagraph>
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            当方は、ユーザーへの事前通知なく本サービスの内容を変更・停止できるものとし、それにより生じた損害について一切の責任を負いません。
          </LegalParagraph>
        </section>
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            当方は必要に応じて本規約を変更することができ、変更後にユーザーが本サービスを利用した場合、当該変更に同意したものとみなします。
          </LegalParagraph>
        </section>
