  ...
  return (
    ...
    >
      <Container className="space-y-10">
        ...
        <LegalParagraph>
          本規約は、{SITE_OPERATOR}（以下「当方」といいます。）が運営する「
          {SITE_NAME}
          」のAIインタビュー機能（以下「本AIインタビュー機能」といいます。）を通じて取得した回答内容に基づき、当方がオープンデータとして公開するデータセット（以下「本データ」といいます。）を、第三者（以下「利用者」といいます。）が利用するにあたっての条件を定めるものです。利用者は、本データをダウンロードまたは利用することにより、本規約に同意したものとみなされます。
        </LegalParagraph>

        <section className="space-y-4">
          <LegalSectionTitle>第1条（本データの内容）</LegalSectionTitle>
          <LegalParagraph>
            利用者が利用することのできる本データは、本AIインタビュー機能を通じて取得した回答ログおよびサマリーのうち、回答者本人が公開に同意したものから、氏名、住所、連絡先その他特定の個人を識別できる情報を除去したものに限られます。
          </LegalParagraph>
        </section>
        ...
        <section className="space-y-4">
          ...
          <LegalList
            items={[
              `データ出典：「${SITE_NAME} AIインタビュー（${SITE_OPERATOR}）」`,
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            当方は、利用者が本規約に違反したと判断した場合、事前に通知することなく、本データの利用停止、ダウンロードの制限、当該成果物の公開停止の要請、その他当方が必要と判断する措置を講じることができるものとします。本条の措置は、損害賠償その他の請求を妨げるものではありません。
          </LegalParagraph>
        </section>
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            本データに関する一切の権利は、当方または正当な権利者に帰属します。本規約は、第2条に定める範囲を超えて、利用者にいかなる権利の譲渡またはライセンスを行うものではありません。
          </LegalParagraph>
        </section>
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            当方は、本データの正確性、完全性、最新性、有用性、特定目的への適合性等について、いかなる保証も行いません。本データは、AIによる対話を通じて取得された回答内容を基にしたものであり、誤った情報、偏った見解、不適切な表現等を含む可能性があることを利用者は理解した上で利用するものとします。
          </LegalParagraph>
          <LegalParagraph>
            当方は、本データの利用または利用不能に起因または関連して利用者または第三者に生じた一切の損害について、責任を負わないものとします。
          </LegalParagraph>
        </section>
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            当方は、利用者への事前通知なく、本データの提供内容の変更、提供範囲の縮小、または提供の停止を行うことができるものとし、それにより生じた損害について一切の責任を負いません。
          </LegalParagraph>
        </section>
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            当方は、必要に応じて本規約を変更することができ、変更後に利用者が本データを利用した場合、当該変更に同意したものとみなします。
          </LegalParagraph>
        </section>
