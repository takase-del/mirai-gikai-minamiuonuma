...
export default function PrivacyPage() {
  return (
    <LegalPageLayout
      ...
      description={`${SITE_OPERATOR}（以下「当方」といいます）における個人情報の取り扱いについてご説明します。`}
    >
      <Container className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <LegalList
            items={[
              ...
              "当方の提供するサービスであるみらい議会におけるAIインタビュー機能（以下「本AIインタビュー機能」といいます。）を通じて取得される対話ログ、音声データ、および行動履歴",
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            個人情報をご提供いただく際には、ユーザーの同意に基づいて行うことを原則とします。また、当方は、以下に定める目的での利用を除き、個人情報を無断で利用することはありません。
          </LegalParagraph>
          <LegalList
            items={[
              "ユーザーが利用する当方のサービス（以下「当方サービス」といいます。）の運営およびそれに伴うユーザーとのやりとり・情報提供",
              "当方サービスの安全な運営に必要な不正対策",
              "当方サービスの改善・新規開発",
              "当方における政策立案",
              "当方サービスに係る情報提供・広告配信",
              "上記の各利用目的に必要な各種調査・分析",
          ...
          />
          <LegalParagraph>
            なお、本AIインタビュー機能を通じて当方が取得した回答内容については、当方は、以下の通り取り扱います。
          </LegalParagraph>
          <LegalList
            items={[
              {
        ...
        <section className="space-y-4">
          ...
          <LegalList
            items={[
              "「2. 個人情報の収集方法と使用範囲」に定める本AIインタビュー機能を通じて当方が取得した回答内容を、本人が公開に同意した範囲で公開する場合、および別途定める「みらい議会AIインタビューデータ利用規約」に同意する者であれば誰でもダウンロード可能なオープンデータとして第三者に提供する場合",
              "ユーザー本人の同意がある場合",
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            取得した個人情報および対話ログは、法令（政治資金規正法等）に基づき必要な期間（原則7年間）保管した後、適切な方法で廃棄・削除します。なお、本人の同意に基づき公開された回答内容、および個人を特定できないよう加工した上でオープンデータとして提供されたデータなど当方が管理していない情報は、廃棄・削除を行うことはできないため、継続して公開・提供されることがあります。
          </LegalParagraph>
        </section>
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            個人情報の確認・修正・削除、または本AIインタビュー機能の回答公開の停止等のご相談は、下記までご連絡ください。
          </LegalParagraph>
